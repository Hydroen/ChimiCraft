...
public class BlockComposer extends Block
{
	private IIcon top, bottom;
	
	public BlockComposer(Material material) 
	{
		super(material);
	...
	{
		this.blockIcon = iiconRegister.registerIcon(ModChimiCraft.MODID + ":composer");
		this.top = iiconRegister.registerIcon(ModChimiCraft.MODID + ":composerback");
		this.bottom = iiconRegister.registerIcon(ModChimiCraft.MODID + ":composerback");
	}
	...
	public void breakBlock(World world, int x, int y, int z, Block block, int metadata)
	{
		...
		super.breakBlock(world, x, y, x, block, metadata);
	}
